...
#       Enums
# ==================
class PlatformErrorCodes(DocumentedIntEnum):
    None_ = 0
    Success = 1
    ...
    DestinyCharacterNotInTower = 1634, (
        'Note = This is one of those holdovers from Destiny 1. We didn\'t change the enum because I am lazy, but in '
        'Destiny 2 this would read "DestinyCharacterNotInSocialSpace"'
    )
